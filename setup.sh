...
IZIN=$( curl https://raw.githubusercontent.com/Rajibul75/ip/main/register | grep $MYIP )
if [ $MYIP = $IZIN ]; then
echo -e "${green}Permission Accepted...${NC}"
else
echo -e "${red}Permission Denied!${NC}";
echo "Please Contact Admin"
echo "Telegram t.me/sam_sfx"
echo "WhatsApp wa.me/60132527814"
rm -f setup.sh
exit 0
fi
echo ''
echo '  __  _   _   _  _ _  ___ _  _ '
echo ' / _|/ \ | \_/ || | || o \ \| | '
echo ' \_ \ o || \_/ || V ||  _/ \\ | '
echo ' |__/_n_||_| |_| \_/ |_| |_|\_|  '
echo '      Unlimited Segalanya '
echo ''
echo ' .................................... '
echo '      Autoscript By SAMVPN   '
echo '         Build in 2021       '
...
echo ""  | tee -a log-install.txt
echo "   - Dev/Main                : SAMVPN"  | tee -a log-install.txt
echo "   - Telegram                : t.me/sam_sfx"  | tee -a log-install.txt
echo "   - Instagram               : @sfxq.s"  | tee -a log-install.txt
